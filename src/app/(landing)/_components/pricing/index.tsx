...
export const PricingSection = () => {
  return (
    <div className="w-full pt-20 flex flex-col items-center gap-3" id="pricing">
      <BackdropGradient className="w-10/12 h-full opacity-40  flex flex-col items-center">
        <GradientText
        ...
        <p className="text-sm md:text-center text-left text-muted-foreground">
          Learnyst is a vibrant online community platform that empowers people to
